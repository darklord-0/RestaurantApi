...
function fetchAllRestaurants()
{
  ...
  req.open("GET",`https://foodbukka.herokuapp.com/api/v1/restaurant?sort=${sort.value}`);
  ...
  req.addEventListener("load",function()
  {
    ...
    if(order.value==="inc")
      ...
      showAllRestaurants((JSON.parse(req.responseText).Result).reverse());
